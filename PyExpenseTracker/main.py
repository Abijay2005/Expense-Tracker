...
#########################àSTRUTTURA PAGINA###############################
    ...
    def altro_page():
        ...
        def crea_istogramma(file_spese, file_entrate, anno_corrente):
            ...
            plt.savefig(f'assets/images/istogramma_{anno_corrente}.jpg', pad_inches=0.1, bbox_inches="tight")
            plt.clf()
            plt.close()
        page.clean()
        ...
        def crea_grafici(e):
            ...
            if date_picker_prima.value is not None and date_picker_seconda.value is not None:
                ...
                crea_grafico_torta('assets/spese.csv', 'assets/images/grafico_spesa.jpg', date_picker_prima.value.strftime("%Y-%m-%d"), date_picker_seconda.value.strftime("%Y-%m-%d"))
                crea_grafico_andamento_patrimonio('assets/images/grafico_patrimonio.jpg', date_picker_prima.value.strftime("%Y-%m-%d"), date_picker_seconda.value.strftime("%Y-%m-%d"))
              
                image1=ft.Image(src="assets/images/grafico_spesa.jpg",width=350,height=350)
                image2= ft.Image(src="assets/images/grafico_patrimonio.jpg", width=350,height=350)
                image3=ft.Image(src=f"assets/images/istogramma_{anno_corrente}.jpg", width=350,height=350)
                
                page.add(ft.Column([
                    ft.Container(ft.Text("Ecco i tuoi grafici",weight="bold",font_family="Georgia",size=30),margin=5,
                    padding=5,
